...
const navItems = [
  ...
  { to: '/homework', label: 'Uy Vazifalari', icon: ClipboardList, roles: ['ADMIN', 'TEACHER'] },
  { to: '/qr-attendance', label: 'QR Davomat', icon: QrCode, roles: ['ADMIN', 'TEACHER'] },
  { to: '/resources-manage', label: 'Resurslar', icon: Library, roles: ['ADMIN', 'TEACHER'] },
  { to: '/reports', label: 'Hisobotlar', icon: Download, roles: ['ADMIN', 'RECEPTION'] },
  { to: '/certificates', label: 'Sertifikatlar', icon: Award, roles: ['ADMIN', 'TEACHER'] },
  { to: '/teacher-schedule', label: "O'qituvchi Jadvali", icon: Calendar, roles: ['ADMIN', 'RECEPTION'] },
  { to: '/sms', label: 'SMS Xabarnoma', icon: MessageSquare, roles: ['ADMIN'] },
  { to: '/bulk-operations', label: 'Ommaviy Amallar', icon: Settings, roles: ['ADMIN'] },
  ...
  { to: '/my-homework', label: 'Uy Vazifalari', icon: ClipboardList, roles: ['STUDENT'] },
  ...
  { to: '/mock-tests', label: 'Mock Testlar', icon: ClipboardList, roles: ['STUDENT'] },
